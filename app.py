...
course_info = {
    'ds_course': 'information or resources related to a data science course',
    'web_course': 'information or resources related to a web development course',
    'android_course': 'information or resources related to an Android development course',
    'ios_course': 'information or resources related to an iOS development course',
    'uiux_course': 'information or resources related to a UI/UX design course',
    'resume_videos': 'videos related to resume writing',
    'interview_videos': 'videos related to job interviews'
}

ds_course = course_info['ds_course']
web_course = course_info['web_course']
android_course = course_info['android_course']
ios_course = course_info['ios_course']
uiux_course = course_info['uiux_course']
resume_videos = course_info['resume_videos']
interview_videos = course_info['interview_videos']
...
UPLOAD_FOLDER = 'C:/Users/ishat/OneDrive/Desktop/8th sem project/AI_Personality-Prediction-System-Through-CV-Analysis/CV/'
